            ...
            <div class="content-wrapper">
                <div class="row">
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Update Giỏ Hàng</h4>
                                <form class="forms-sample" action="/UpdateGioHang?id=${gh.id}" method="post">
                                    <div class="form-group">
                                        <label>Mã Khách Hàng</label>
                                        <select class="form-control" class="js-example-basic-single w-100"
                                                name="khachHang.id">
                                            <option value="${gh.khachHang.id}" selected>${gh.khachHang.ma}</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" class="js-example-basic-single w-100"
                                                name="nhanVien.id">
                                            <option value="${gh.nhanVien.id}" selected>${gh.nhanVien.ma}</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="ma" value="${gh.ma}">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="sdt" value="${gh.sdt}">
                                    </div>
                                    <div class="form-group">
                                        <label>Tình trạng</label>
                                        <input type="text" class="form-control" name="tinhTrang" value="${gh.tinhTrang}">
                                    </div>
