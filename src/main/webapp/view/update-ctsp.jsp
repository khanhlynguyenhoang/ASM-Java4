            ...
            <div class="content-wrapper">
                <div class="row">
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Update Chi Tiet San Pham</h4>
                                <form class="forms-sample" action="/UpdateChiTietSanPham?id=${ctsp.id}" method="post">
                                    <div class="form-group">
                                        <label>Ten San Pham</label>
                                        <select class="form-control" class="js-example-basic-single w-100"
                                                name="sanPham.id">
                                            <option value="${ctsp.sanPham.id}" selected >${ctsp.sanPham.ten}</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" class="js-example-basic-single w-100"
                                                name="nhaSanXuat.id">
                                            <option value="${ctsp.nhaSanXuat.id}" selected>${ctsp.nhaSanXuat.ten}</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" class="js-example-basic-single w-100"
                                                name="dongSanPham.id">
                                            <option value="${ctsp.dongSanPham.id}" selected>${ctsp.dongSanPham.ten}</option>
